...
import (
	...
	"go-chat/internal/service/group_info_service"
...
func CreateGroup(c *gin.Context) {
	...
	message, ret := group_info_service.GroupInfoService.CreateGroup(createGroupReq)
...
func LoadMyGroup(c *gin.Context) {
	...
	message, groupList, ret := group_info_service.GroupInfoService.LoadMyGroup(loadMyGroupReq.OwnerId)
...
func CheckGroupAddMode(c *gin.Context) {
	...
	message, addMode, ret := group_info_service.GroupInfoService.CheckGroupAddMode(req.GroupId)
...
func EnterGroupDirectly(c *gin.Context) {
	...
	message, ret := group_info_service.GroupInfoService.EnterGroupDirectly(req.OwnerId, req.ContactId)
	JsonBack(c, message, ret, nil)
}
...
func LeaveGroup(c *gin.Context) {
	...
	message, ret := group_info_service.GroupInfoService.LeaveGroup(req.UserId, req.GroupId)
	JsonBack(c, message, ret, nil)
}
...
func DismissGroup(c *gin.Context) {
	...
	message, ret := group_info_service.GroupInfoService.DismissGroup(req.OwnerId, req.GroupId)
	JsonBack(c, message, ret, nil)
}
...
func GetGroupInfo(c *gin.Context) {
	...
	message, groupInfo, ret := group_info_service.GroupInfoService.GetGroupInfo(req.GroupId)
	JsonBack(c, message, ret, groupInfo)
}

// GetGroupInfoList 获取群聊列表 - 管理员
func GetGroupInfoList(c *gin.Context) {
	message, groupList, ret := group_info_service.GroupInfoService.GetGroupInfoList()
	JsonBack(c, message, ret, groupList)
}
...
func DeleteGroups(c *gin.Context) {
	...
	message, ret := group_info_service.GroupInfoService.DeleteGroups(req.UuidList)
	JsonBack(c, message, ret, nil)
}
...
func SetGroupsStatus(c *gin.Context) {
	...
	message, ret := group_info_service.GroupInfoService.SetGroupsStatus(req.UuidList, req.Status)
	JsonBack(c, message, ret, nil)
}
...
func UpdateGroupInfo(c *gin.Context) {
	...
	message, ret := group_info_service.GroupInfoService.UpdateGroupInfo(req)
	JsonBack(c, message, ret, nil)
}
...
func GetGroupMemberList(c *gin.Context) {
	...
	message, groupMemberList, ret := group_info_service.GroupInfoService.GetGroupMemberList(req.GroupId)
...
func RemoveGroupMembers(c *gin.Context) {
	...
	message, ret := group_info_service.GroupInfoService.RemoveGroupMembers(req)
	JsonBack(c, message, ret, nil)
}
